...
3. **Resource responsiveness:** let the first real collection-heavy play request expose the next acquisition blocker. If collection repeats no-progress signatures, repair the existing binding/strategy seam instead of increasing timeouts or retries.
