...
- [ ] Next broad tranche: cross meaningful water with a designated player, stay close without oscillating through them, preserve self/player defense, resume Follow after danger, and settle back beside the player on land. Repair only shared swimming, locomotion, follow-settlement, or authority seams exposed by that unchanged companion session.
