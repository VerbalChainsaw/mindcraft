...
- [ ] Next broad tranche: combine conversational authority with shared-outpost stewardship. Ordinary nearby first-person conversation must not start work; an explicitly addressed request must gather a useful nonzero food supply, reuse the existing furnace and selected chest, preserve the house, farm, paths, and fixtures, and end under Operator Stop.
