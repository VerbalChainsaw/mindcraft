...
- [ ] Prove one broad usable overnight outpost at a player-designated site, including construction and actual use. Let that outcome—not synthetic block permutations—select the first required oriented, stateful, multiblock, ownership, or functional-verification repair.
