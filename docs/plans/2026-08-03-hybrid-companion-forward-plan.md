...
Resume broad two-player supervised play rather than another preselected noun or mechanic. IronSuiteProof is Stop-held beside LandingWitness with the verified starter supply. Preserve the player's unchanged useful outcome, observe the first material failure, repair the smallest shared primitive or capability binding, and rerun that outcome physically. Prioritize stale/unintended work, destructive world changes, mobility or repeated no-progress, dishonest completion or restart replay, then genuine missing gameplay domains.

Do not reopen food quantities, furnace states, chest contents, starter-supply quantities/order, river routes, gaze, fence species, or pen-light permutations without new live evidence. Do not turn playtesting into a certification matrix, telemetry project, claimed-world framework, storage controller, or second executor.
