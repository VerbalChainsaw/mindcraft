...
Functional source commit: b8f17d1 (pushed)
Milestone: additional-bucket repeatability physically complete on owned Pathfinder
Sole writer and Minecraft runtime owner: Codex
Owned subsystem: deterministic capability binding and V2-owned Pathfinder locomotion
