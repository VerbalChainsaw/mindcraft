...
>
> **Why it was archived:** It opens "commanded companion gameplay is operational". ARCHITECTURE.md opens by explaining why the bot ignores instructions. Both cannot be the current state.
>
