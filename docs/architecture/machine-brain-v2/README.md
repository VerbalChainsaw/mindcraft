...
2. [Legacy/v2 boundary contract](BOUNDARY-CONTRACT.md) — define adapters, authority, runtime selection, and rollback.
3. [Migration gates](MIGRATION-GATES.md) — constrain what each release may introduce.
4. [Benchmark and kill criteria](BENCHMARK-KILL-CRITERIA.md) — decide advance, hold, rollback, or stop from evidence.
5. [Branch/worktree rules](WORKTREE-RULES.md) — keep architecture work isolated from the runnable checkout.
